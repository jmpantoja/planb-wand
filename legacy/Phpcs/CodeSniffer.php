...
class CodeSniffer
{
     ...
     * @return int
     */
    public function runPHPCS(array $tokens): int
    {
        try {

            CodeSniffer::checkRequirements();

            if (defined('PHP_CODESNIFFER_CBF') === false) {
                define('PHP_CODESNIFFER_CBF', false);
            }

            $this->config = new Config($tokens);
            ...
            $this->output = $this->reporter->printReports();
     ...
     * @return int
     */
    public function runPHPCBF(array $tokens): int
    {
        if (defined('PHP_CODESNIFFER_CBF') === false) {
